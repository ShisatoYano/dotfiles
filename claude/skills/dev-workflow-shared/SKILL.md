...
1. 作業が難航し、`daily-task-planning`で見積もった工数内に完了しそうにないと判断した場合は、無理に完了を目指さず区切りの良いところで作業を区切る。その時点までの進捗を整理し、`notion-task-workflow`のサブワークフロー1(進捗記録)で記録した上で、今後の進め方(今日中に続けるか、翌日以降に持ち越すか、見積もりを見直すか)をユーザーに確認する
